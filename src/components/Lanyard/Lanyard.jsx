...
export default function Lanyard({
  ...
  return (
    <div
      ...
      style={{
        height: isMobile ? "128vh" : "100vh",

        /*
         * Lanyard tetap berada secara visual
         * di atas navbar.
         */
        position: "relative",
        zIndex: 200,
        ...
        /*
         * Canvas tidak menjadi penghalang
         * terhadap navbar.
         */
        pointerEvents: "none",
      }}
    >
      <Canvas
        ...
        /*
         * Canvas sendiri tidak mengambil pointer.
         * Interaksi card ditangani melalui konfigurasi
         * pointer-events pada object 3D.
         */
        style={{
          pointerEvents: "none",
        }}
